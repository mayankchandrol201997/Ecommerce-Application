...
public class OrderController {
    ...
    @PostMapping
    public ResponseEntity<Map<String, Object>> createOrder(@RequestBody OrderRequestDto orderRequestDto) throws JsonProcessingException {
    ...
    public ResponseEntity<Map<String, Object>> getAllOrder() {
        CurrentUser user = SecurityUtils.getCurrentUser();
        return buildResponseEntity(orderService.getAllOrder(user.getUserId()), HttpStatus.OK);
    }
}
